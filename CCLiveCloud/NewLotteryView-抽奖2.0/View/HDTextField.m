...
-(instancetype)init {
    ...
    if (self) {
        ...
        //初始化默认状态
        _isChangeBorder=YES;
        _defaultBorderColor = [UIColor colorWithHexString:@"#E5E5E5" alpha:1];
        _defaultBorderWidth = 0.5;
        _selectBorderColor = [UIColor colorWithHexString:@"#C9C9C9" alpha:1];
        _placeholderColor = [UIColor colorWithHexString:@"#999999" alpha:1];
        self.layer.cornerRadius = 2;
        self.layer.borderWidth = _defaultBorderWidth;
        self.layer.borderColor = _defaultBorderColor.CGColor;
        self.textColor = [UIColor colorWithHexString:@"#38404B" alpha:1];
