...
- (void)setupUI
{
    ...
    [self.onBackgroundView setBackgroundColor:[UIColor colorWithHexString:@"#F89E0F" alpha:1]];
    [self.onBackgroundView.layer setCornerRadius:self.frame.size.height/2];
    ...
    [self.offBackgroundView setBackgroundColor:[UIColor colorWithHexString:@"#666666" alpha:1]];
    [self.offBackgroundView.layer setCornerRadius:self.frame.size.height/2];
