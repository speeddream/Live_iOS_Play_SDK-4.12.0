...
- (void)layoutSubviews
{
    ...
    //self.emojiImageView.image = [UIImage imageNamed:[@"Emotion.bundle" stringByAppendingPathComponent:self.emoji.imageName]];
    self.emojiImageView.image = [Utility emojiFromEmojiName:self.emoji.imageName];
