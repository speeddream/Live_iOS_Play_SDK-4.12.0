...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithHexString:@"#F4F4F4" alpha:1.0f];
...
- (UIView *)bottomBGView
{
    if (!_bottomBGView) {
        ...
        _bottomBGView.backgroundColor = [UIColor colorWithHexString:@"#F4F4F4" alpha:1.0f];
    }
...
- (UIImage *)emojiImageWithName:(NSString *)name
{
    ...
    //return [UIImage imageNamed:[@"Emotion.bundle" stringByAppendingPathComponent:name]];
    return [Utility emojiFromEmojiName:name];
}
...
- (void)reloadEmojisDefault {
    [[PPStickerDataManager sharedInstance] reloadEmojisDefault];
    _stickers = [PPStickerDataManager sharedInstance].allStickers.copy;
    [self changeStickerToIndex:0];
}

- (void)reloadEmojisCustom:(NSArray *)emojis {
    [[PPStickerDataManager sharedInstance] reloadEmojisCustom:emojis];
    _stickers = [PPStickerDataManager sharedInstance].allStickers.copy;
    [self changeStickerToIndex:0];
}
@end
