...
-(void)initUI {
    ...
    [_fileNameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(ws).offset(-15);
        make.top.mas_equalTo(ws).offset(15);
    ...
    [_progressLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(ws.fileNameLabel.mas_bottom).offset(5);
        make.height.mas_equalTo(10);
    }];
    [self addSubview:self.backView];
    [_backView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(ws.progressLabel);
        make.top.mas_equalTo(ws.progressLabel.mas_bottom).offset(5);
        make.size.mas_equalTo(CGSizeMake(UISCREENWIDTH - 15 - 40, 20));
    }];
    ...
    [_downloadImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(ws.backView.mas_right).offset(10);
    ...
    [_informationLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(ws.fileNameLabel);
        make.right.mas_equalTo(ws.fileNameLabel);
        make.top.mas_equalTo(ws.backView.mas_bottom).offset(5);
