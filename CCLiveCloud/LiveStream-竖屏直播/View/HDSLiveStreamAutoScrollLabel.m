//
//  HDSLiveStreamAutoScrollLabel.m
//  CCLiveCloud
//
...
#define AutoLabel_pause 1
#define AutoLabel_betweenGap 50

@interface HDSLiveStreamAutoScrollLabel () {
    UILabel *_label[NumLabels];
    NSInteger _speed;
}
@end

@implementation HDSLiveStreamAutoScrollLabel
...
- (void)loadUI {
    for (NSInteger i = 0; i < NumLabels; i++) {
        ...
        _label[i].font = [UIFont systemFontOfSize:12];
