...
@class RemindModel;
@class HDSHistoryTopChatModel;
@class HDSLiveTopChatModel;
@class HDSDeleteTopChatModel;
...
/// 发送聊天消息回调
@property (nonatomic, copy) sendChatMessage sendChatMessage;
/// 是否禁用声音
